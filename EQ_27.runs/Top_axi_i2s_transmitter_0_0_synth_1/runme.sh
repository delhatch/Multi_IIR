...
HD_PWD='C:/Zynq_Book/EQ_27/EQ_27.runs/Top_axi_i2s_transmitter_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Top_axi_i2s_transmitter_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Top_axi_i2s_transmitter_0_0.tcl
