...
HD_PWD='C:/Zynq_Book/EQ_27/EQ_27.runs/Top_rst_ps7_0_100M_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Top_rst_ps7_0_100M_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Top_rst_ps7_0_100M_0.tcl
