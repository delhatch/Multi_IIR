...
if { ${design_name} eq "" } {
  ...
  set_property USER_COMMENTS.comment_0 "IIR filter coefficient memory" [get_bd_designs $design_name]
...
proc create_root_design { parentCell } {
 ...
 ] [get_bd_intf_pins /eq_core_0/BRAM]
  ...
  set_property -dict [ list \
   ...
   CONFIG.PCW_FPGA1_PERIPHERAL_FREQMHZ {10.0} \
  ...
  connect_bd_intf_net -intf_net eq_core_0_BRAM [get_bd_intf_pins blk_mem_gen_0/BRAM_PORTB] [get_bd_intf_pins eq_core_0/BRAM]
  ...
  connect_bd_net -net processing_system7_0_FCLK_CLK0 [get_bd_pins axi_bram_ctrl_0/s_axi_aclk] [get_bd_pins axi_gpio_0/s_axi_aclk] [get_bd_pins axi_i2s_receiver_0/m_axis_aclk] [get_bd_pins axi_i2s_transmitter_0/s_axis_aclk] [get_bd_pins axi_interconnect_0/ACLK] [get_bd_pins axi_interconnect_0/M00_ACLK] [get_bd_pins axi_interconnect_0/M01_ACLK] [get_bd_pins axi_interconnect_0/M02_ACLK] [get_bd_pins axi_interconnect_0/S00_ACLK] [get_bd_pins eq_core_0/m_axis_aclk] [get_bd_pins eq_core_0/s00_axi_aclk] [get_bd_pins eq_core_0/s_axis_aclk] [get_bd_pins processing_system7_0/FCLK_CLK0] [get_bd_pins processing_system7_0/M_AXI_GP0_ACLK] [get_bd_pins rst_ps7_0_100M/slowest_sync_clk]
  ...
  connect_bd_net -net rst_ps7_0_100M_peripheral_aresetn [get_bd_pins axi_bram_ctrl_0/s_axi_aresetn] [get_bd_pins axi_gpio_0/s_axi_aresetn] [get_bd_pins axi_i2s_receiver_0/m_axis_aresetn] [get_bd_pins axi_i2s_transmitter_0/s_axis_aresetn] [get_bd_pins axi_interconnect_0/M00_ARESETN] [get_bd_pins axi_interconnect_0/M01_ARESETN] [get_bd_pins axi_interconnect_0/M02_ARESETN] [get_bd_pins axi_interconnect_0/S00_ARESETN] [get_bd_pins eq_core_0/m_axis_aresetn] [get_bd_pins eq_core_0/s00_axi_aresetn] [get_bd_pins eq_core_0/s_axis_aresetn] [get_bd_pins rst_ps7_0_100M/peripheral_aresetn]
