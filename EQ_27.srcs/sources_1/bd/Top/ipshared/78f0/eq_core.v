...
`timescale 1 ns / 1 ps
	...
	(
		...
		output BRAM_EN,
		output [15:0] BRAM_WE,
		output [8:0] BRAM_ADDR,    // 30 bands * 16 bytes per band. (L & R coefficients are the same.)
...
// Instantiation of Axi Bus Interface S00_AXI
	eq_core_v1_0_S00_AXI # ( 
	    ...
	    .lrclk( lrclk ),
	    .coefs( BRAM_DOUT ),
	    .coef_addr( BRAM_ADDR ),                   // output, to call up filter coeeficients for each "instance" of the time-multiplexed IIR filter.
...
// This module sends the processed (EQ'd) audio signal to the Slave module, to be sent to the DAC.
	...
	// BRAM signals. Address and data ports assigned above in the eq_core_v1_0_S00_AXI_inst.
